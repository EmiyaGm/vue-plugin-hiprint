      ...
      <a-space style="margin-bottom: 10px">
        <a-button-group>
          ...
          >
            ...
            <a-button :type="'other' == curPaperType ? 'primary' : ''"
              >自定义纸张</a-button
            >
          </a-popover>
        </a-button-group>
          ...
          <a-row>
            ...
            >
              ...
              <a-row v-if="currVerInfo.verVal >= 55.3" style="height: 100px">
                ...
                <a-col :span="12" class="drag_item_box">
                  <div>
                    <a class="ep-draggable-item" tid="defaultModule.wxqrcode">
                      <span
                        class="glyphicon glyphicon-qrcode"
                        aria-hidden="true"
                      ></span>
                      <p class="glyphicon-class">微信二维码</p>
                    </a>
                  </div>
                </a-col>
                <a-col :span="12" class="drag_item_box">
...
export default {
  ...
  mounted() {
    ...
    // }
    hiprint = vuePluginHiprint.hiprint
    defaultElementTypeProvider = provider(hiprint)
    this.init()
  },
  methods: {
    /**
